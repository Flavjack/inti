...
- [`rticle()`](https://inkaverse.com/dev/reference/rticle.md) improve
  crossrefs
...
- Improve function
  [`rticle()`](https://inkaverse.com/dev/reference/rticle.md) to render
...
- [`H2cal()`](https://inkaverse.com/dev/reference/H2cal.md) was updated
  to include factors as formula
...
- Update functions bookdown to quarto:
  ...
  - `table2rmd()` ==\> `table2qmd()`
  - `gdocs2rmd()` ==\> `gdocs2qmd()`
- Fix [`plot_raw()`](https://inkaverse.com/dev/reference/plot_raw.md):
  “length(x) = 2 \> 1’ in coercion to ’logical(1)”
- Update `jc_tombola()`
- `outliers_remove(drop.na = FALSE)` avoid drop NA values by default
- [`H2cal()`](https://inkaverse.com/dev/reference/H2cal.md) outliers are
...
- Package:
  ...
  - `width` argument
- Fix [`plot_smr()`](https://inkaverse.com/dev/reference/plot_smr.md):
  “length(x) = 2 \> 1’ in coercion to ’logical(1)”
- New function:
...
- Update diagnostic plot in
  [`plot_diag()`](https://inkaverse.com/dev/reference/plot_diag.md) to
  lm and lmerMod.
...
- *Package*
  - [`H2cal()`](https://inkaverse.com/dev/reference/H2cal.md): BLUEs
    from H2cal may be wrong if other fixed effects in the model
...
- *Package*
  - Include info
    [`plot_smr()`](https://inkaverse.com/dev/reference/plot_smr.md) and
    `plot_raw`
  - [`plot_smr()`](https://inkaverse.com/dev/reference/plot_smr.md)
    - Delete legend border
  - Transparent logos background
  - New vignette for coding with yupana
  - Update Rticles and Books template
  - Fix
    [`web_table()`](https://inkaverse.com/dev/reference/web_table.md) to
    export in xlsx
  - [`plot_raw()`](https://inkaverse.com/dev/reference/plot_raw.md) with
...
- *Package*
  ...
  - [`plot_raw()`](https://inkaverse.com/dev/reference/plot_raw.md)
    - Allows vector with colors for plots
    - Include “scatter plot”
  - [`H2cal()`](https://inkaverse.com/dev/reference/H2cal.md) include
    trial option for MET
...
- *Package*
  ...
  - Vignettes: comparison between
    [`H2cal()`](https://inkaverse.com/dev/reference/H2cal.md) and
    `asreml`
