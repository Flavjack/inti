...
subtitle: "Comparison: asreml and H2cal"
...
colorlinks: true
zotero: true
bibliography: [C:/Users/User/git/inti/vignettes/files/book.bib, C:/Users/User/git/inti/vignettes/files/pkgs.bib]
...
For the comparison we will use the two methods described by @buntaran2020Cross. (i) The "two-stage" analysis, using two stages, the first to calculate the BLUE and the second the BLUPs. (ii) The "one stage" analysis using only one model to calculate the BLUPs.
